  ...
  const pages = [
    ...
    },
    {
      ...
      content: [
        ...
        <strong><em>I expect the results to be life changing. Loving the Lord with all our hearts is foundational. Once that foundation is in place the possibilities for transformation, holiness, contentment and God's coming kingdom are limitless.</em></strong>
      ],
    ...
    },
    {
      ...
      content: [
        ...
        "Holiness starts as we purify our hearts with God's full presence. If we wholeheartedly love God, that will overflow into wholeheartedly loving other people."
      ],
    ...
    },
    {
      ...
      content: [
        ...
        "We should examine ourselves closely and honestly, being aware of how deceitful our hearts can be. Sometimes we discover we love things more than we realized."
      ],
    ...
    {
      number: 10,
      title: "Neither Idols Nor Sin Can Ever Satisfy",
      content: [
        ...
        "No idol or sin can ever satisfy the heart's deepest longings. They are like a sweet with a poisonous centre."
      ],
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
          <a
            ...
            aria-label="Buy Loving God on Amazon"
